...
Fine-tuning large models breaks in two ways.

First, compute — updating tens of millions of parameters is expensive and often impractical.  
Second, stability — the more you update, the more you risk overwriting what the model already knows.
